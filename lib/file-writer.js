...
var CSS_BUNDLE_PATH = "/buster/buster-" + BUSTER_TEST_VERSION + ".css";
    ...
    async.parallel(
        {
            ...
            "buster-test2.css": function (cb) {
                var cssPath = path.resolve(
                    require.resolve("buster-test/resources/buster-test2.css"));
                fs.writeFile(self.outputFolder + CSS_BUNDLE_PATH,
                    fs.readFileSync(cssPath), cb);
            }
        },
...
module.exports = {
    ...
    CSS_BUNDLE_PATH: CSS_BUNDLE_PATH,
